...
The good news is that the Moon is not actually changing at all. What changes is the geometry between the Sun, the Earth, and the Moon, and the slice of the lit half that happens to be facing us. Once that geometry clicks into place, the whole cycle stops being a mystery and becomes something you can predict in your head.
...
A: The four "shaped" phases, meaning the crescents and gibbous stages, each last about a week as the Moon transitions. The named moments like new, full, and the quarters are technically instants, but the Moon looks essentially full or half for a day or so on either side, which is why a full moon seems to last a couple of nights.`,
  },
  {
...
A standard tarot deck has seventy-eight cards split into two groups. The Major Arcana is the famous twenty-two: The Fool, The Magician, The High Priestess, and so on up to The World. These cards deal with big life themes and turning points like fate, transformation, and spiritual lessons. When several Major Arcana appear in a reading, the traditional interpretation is that significant, longer-term forces are at play.

The remaining fifty-six cards are the Minor Arcana, and they work much like ordinary playing cards. They are divided into four suits (Wands, Cups, Swords, and Pentacles), each running from Ace through ten, plus four court cards (Page, Knight, Queen, King). The Minor Arcana speak to everyday matters: work, relationships, money, conflicts, small decisions. Most historians, including those cited by Britannica, note that tarot began in fifteenth-century Europe as a card game and was only adapted for divination centuries later. That is a useful reminder that the imagery is a human invention rich with symbolism, not an ancient oracle.
...
So before you know a single individual card meaning, you can already say something. Pull a Cups card and the reading touches your emotional life; pull a Pentacles card and it touches the practical and financial. The number adds a second layer. Aces are beginnings, fives tend to bring challenge or loss, and tens bring completion. So "Five of Cups" already suggests an emotional setback, and "Ace of Pentacles" suggests a fresh material opportunity, before you open a single book.

## How to read a single card

Start with one card. Shuffle while holding a question in mind, then draw. Before reaching for any reference, look at the image and notice your gut reaction. What is happening in the scene? What is the figure doing, reaching, resting, or turning away? What is the mood, the colour, the weather? This first impression is the heart of intuitive reading and it matters more than any keyword.
...
The first organising layer is the four elements, which sort the twelve signs into groups of three and tell you a lot about temperament. Aries, Leo, and Sagittarius are the fire signs, associated with drive and spontaneity. The earth signs are Taurus, Virgo, and Capricorn, grounded and focused on the material world. Gemini, Libra, and Aquarius make up the air group, which leans intellectual and idea-driven. Finally, the water signs (Cancer, Scorpio, Pisces) tend to be emotional and relationship-focused.
...
None of this "disproves" astrology so much as clarify what it is. Astrology is a symbolic tradition built on the seasonal sky, not a branch of astronomy. Knowing the difference lets you enjoy it without confusing it with observational fact, which is exactly the line Portal Astra draws between its NASA-sourced science and its clearly-labelled reflective content.
...
Three kinds of solar activity drive space weather, and Portal Astra surfaces all of them. Solar flares are sudden flashes of radiation from the Sun's surface, classified by letter from weakest to strongest (C, M, and X), with X-class being the most powerful. Their light reaches us in about eight minutes and can disturb radio communications almost immediately.
...
When this material couples with Earth's magnetic field, it funnels charged particles down toward the magnetic poles. Those particles collide with gases in the upper atmosphere, mainly oxygen and nitrogen, and make them glow, producing the aurora. Green comes from oxygen at lower altitudes; reds and purples from oxygen and nitrogen higher up. The same physics that lights up the sky is described, from the geometry side, in our companion piece on how sunlight and shadow shape what we see, but here the glow is Earth's own atmosphere responding to the Sun.
...
For most of us, though, the index is a window into a genuinely cosmic process: the connection between a storm on the Sun and a glow over our own heads a couple of days later. Watching the number climb after a big CME, and then stepping outside to see the result, is one of the most direct experiences of the solar system you can have without a telescope. It is the same Sun whose position the DSCOVR satellite watches from deep space in Earth From a Million Miles: The EPIC Camera, and the same Sun whose light makes visible the rocky visitors we track in Near-Earth Objects: Should We Worry. Together they are three different windows onto one busy neighbourhood.
...
A: No. Earth's atmosphere and magnetic field protect those of us on the surface. The risks from strong storms are to technology (power grids, satellites, GPS, and radio) and to a lesser extent to astronauts and passengers on high-altitude polar flights. For ordinary observers a high Kp is simply good news for aurora.`,
  },
  {
    ...
    body: `Every day, a camera a million miles from home takes a photograph of the entire sunlit face of our planet. The result is a single frame containing all the weather, all the oceans, and very nearly every living thing we know of. The instrument is called EPIC, the spacecraft carrying it is DSCOVR, and the images it returns are some of the most quietly moving pictures in all of science. Portal Astra pulls the latest EPIC image onto its Earth tab, and this guide explains what you are actually looking at.
...
A: You can tell roughly by eye, since a growing crescent in the evening is waxing while a shrinking one before dawn is waning, and the full mechanics are explained in Moon Phases Explained. For an exact reading, Portal Astra displays the current phase and approximate illumination on its main dashboard every day.`,
  },
  {
...
Portal Astra generates a fresh daily horoscope for Capricorn each morning, drawing on real-time planetary positions. It tracks Saturn's transits and the slower influences that matter most when you are playing the long game.
...
Portal Astra generates a fresh daily horoscope for Aquarius each morning, drawing on real-time planetary positions. It surfaces Uranus transits and the unexpected shifts that often matter most to a sign built for the unconventional.
...
Portal Astra generates a fresh daily horoscope for Pisces each morning, drawing on real-time planetary positions. It pays close attention to Neptune transits and the dream-like cycles that resonate most with this watery, intuitive sign.
